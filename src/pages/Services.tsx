    ...
    <Layout>
      ...
      <section className="relative py-16 md:py-24 bg-background overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <span className="text-primary font-semibold text-xs sm:text-sm uppercase tracking-wider">What We Do</span>
                ...
                return (
                  ...
                  >
                    <div className={`text-center lg:text-left ${index % 2 === 1 ? 'lg:col-start-2' : ''}`}>
                      <div className={`w-14 h-14 md:w-16 md:h-16 rounded-2xl ${service.color} flex items-center justify-center mb-4 md:mb-6 mx-auto lg:mx-0`}>
                        <IconComponent className="w-7 h-7 md:w-8 md:h-8 text-primary-foreground" />
                      </div>
                      <span className="text-muted-foreground text-xs md:text-sm font-medium">{service.subtitle}</span>
                      <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mt-2 mb-3 md:mb-4">{service.title}</h2>
