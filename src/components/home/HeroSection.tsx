    ...
    <section className="relative min-h-[90vh] flex items-center bg-secondary overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/20 text-secondary-foreground/90 text-sm font-medium mb-8 animate-fade-in">
            <span className="w-2 h-2 bg-success rounded-full animate-pulse" />
            Digital Marketing Agency in Attur
          </div>

          {/* Main Heading */}
          <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold text-secondary-foreground mb-6 leading-tight animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
          ...
          {/* Subtitle */}
          <p className="text-lg md:text-xl text-secondary-foreground/80 mb-10 max-w-2xl mx-auto leading-relaxed opacity-0 animate-fade-in-up" style={{ animationDelay: "0.4s" }}>
          ...
          {/* Trust Badges */}
          <div className="mt-16 pt-8 border-t border-secondary-foreground/10 opacity-0 animate-fade-in-up" style={{ animationDelay: "0.8s" }}>
            <p className="text-secondary-foreground/60 text-sm mb-6">Trusted by businesses across India</p>
            <div className="flex flex-wrap justify-center gap-8 items-center text-secondary-foreground/40">
              <span className="text-2xl font-bold">50+ Clients</span>
              <span className="hidden sm:block w-px h-8 bg-secondary-foreground/20" />
